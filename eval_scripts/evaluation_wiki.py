...
from process_sql import tokenize, get_tables_with_alias, get_sql, Schema
...
def get_schemas_from_json(fpath, dbpath):
...
def evaluate(gold, predict, db_dir, etype, kmaps, table):
    ...
    for p, g in zip(plist, glist):
        ...
        schema = Schema(get_schemas_from_json(table_file, db_name))
